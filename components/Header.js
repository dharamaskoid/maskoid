            ...
            return (
              <div key={item} className="relative group">
                ...
                >
                  ...
                  {/* 🔥 CLEAN CHEVRON */}
                  {isServices && (
                    <span className="ml-2 inline-block w-2 h-2 border-r-2 border-b-2 border-[#1a2e5e] rotate-45 transition-transform duration-300 group-hover:rotate-[225deg] group-hover:border-[#2b4c9a]"></span>
                  )}
