 ...
 const nextRef = useRef<HTMLButtonElement | null>(null);
  ...
  return (
    <main className="bg-white overflow-hidden pt-[81.5px] lg:pt-[81.5px]">
      ...
      {/* TECHNOLOGIES WE USE */}
      <section className="relative w-full min-h-[400px] bg-[#0B0827] text-white overflow-hidden py-16 px-6 md:px-16 font-sans">
        ...
        <div className="container mx-auto relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">  
          ...
          <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[700px] h-[400px] opacity-40 pointer-events-none z-0">
          ...
          {/* Left Content Column */}
          <div className="max-w-xl z-10 flex flex-col space-y-4 text-left w-full md:w-1/2">
          ...
          {/* Right Content Column (Clean 2-Column Grid Layout for Cards) */}
          <div className="grid grid-cols-2 gap-4 z-10 w-full md:w-auto">
            
            {/* Card 1: React */}
            <div className="flex items-center gap-3 bg-[#120E36]/80 backdrop-blur-md border border-slate-800 hover:border-indigo-500/50 transition-all duration-300 rounded-xl px-5 py-3 w-full sm:w-44 shadow-[0_4px_20px_rgba(0,0,0,0.4)]">
