             ...
             {/* PREMIUM MARQUEE SECTION */}
              ...
              <section className="relative py-16 bg-[#EEF2FF] text-white overflow-hidden">
                ...
                <motion.div
                  ...
                  className="absolute -top-40 left-20 w-96 h-96 bg-blue-500/10 blur-3xl rounded-full pointer-events-none"
                />
                ...
                <motion.div
                  ...
                  className="absolute bottom-0 right-20 w-96 h-96 bg-purple-500/10 blur-3xl rounded-full pointer-events-none"
                />

                {/* GRID PATTERN */}
                <div className="absolute inset-0 opacity-[0.03] bg-[linear-gradient(to_right,#1a2e5e_1px,transparent_1px),linear-gradient(to_bottom,#1a2e5e_1px,transparent_1px)] bg-[size:40px_40px] pointer-events-none" />
                ...
                <motion.div
                  ...
                  className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-blue-400/5 blur-3xl rounded-full pointer-events-none"
                />
                ...
                <div className="max-w-6xl mx-auto px-6 relative z-10">
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      {/* YOUR EXISTING SLIDES KEEP SAME */}
