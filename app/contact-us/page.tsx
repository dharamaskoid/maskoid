    ...
    <main className="bg-white overflow-hidden pt-[81.5px] lg:pt-[81.5px]">
      ...
      <div className="container mx-auto bg-[#1a2e5e] rounded-2xl border border-[#dbe7ff] p-10">
        ...
        <div className="relative w-full max-w-[580px]">
            ...
            {/* BACKGROUND GLOW */}
            <div className="absolute -top-10 left-10 w-60 h-60 bg-blue-500/20 blur-[100px] rounded-full"></div>
            <div className="absolute bottom-0 right-0 w-52 h-52 bg-[#6EA8FF]/20 blur-[90px] rounded-full"></div>

            {/* MAP CARD */}
            <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl shadow-[0_30px_80px_rgba(0,0,0,0.35)]">
            ...
            <div className="absolute top-[32%] left-[22%]">
                ...
                <span className="absolute w-5 h-5 rounded-full bg-blue-400 animate-ping opacity-70"></span>
                <span className="relative w-4 h-4 rounded-full bg-blue-500 border-2 border-white"></span>
                </div>
            </div>
            ...
            <div className="absolute top-[24%] left-[47%]">
                <div className="relative flex items-center justify-center">
                <span className="absolute w-5 h-5 rounded-full bg-[#6EA8FF] animate-ping opacity-70"></span>
                <span className="relative w-4 h-4 rounded-full bg-[#6EA8FF] border-2 border-white"></span>
                </div>
            </div>

            {/* INDIA */}
            <div className="absolute top-[45%] left-[66%]">
                <div className="relative flex items-center justify-center">
                <span className="absolute w-5 h-5 rounded-full bg-cyan-400 animate-ping opacity-70"></span>
                <span className="relative w-4 h-4 rounded-full bg-cyan-400 border-2 border-white"></span>
                </div>
            </div>
            ...
            <div className="absolute top-[42%] left-[58%]">
                <div className="relative flex items-center justify-center">
                <span className="absolute w-5 h-5 rounded-full bg-purple-400 animate-ping opacity-70"></span>
                <span className="relative w-4 h-4 rounded-full bg-purple-400 border-2 border-white"></span>
                </div>
            </div>
            ...
            >
                <path
                d="M220 200 C350 120, 480 160, 580 250"
                stroke="rgba(110,168,255,0.4)"
                strokeWidth="2"
                strokeDasharray="8 8"
                />
                <path
                d="M580 250 C650 280, 720 260, 760 300"
                stroke="rgba(110,168,255,0.4)"
                strokeWidth="2"
                strokeDasharray="8 8"
                />
