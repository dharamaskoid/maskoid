      ...
      <section className="relative py-16 bg-white overflow-hidden">
        ...
        <div className="container px-6 mx-auto relative z-10">
          ...
          >
            ...
            {/* GRID PATTERN */}
            <div className="absolute inset-0 opacity-[0.04] bg-[radial-gradient(circle,#ffffff_1px,transparent_1px)] [background-size:24px_24px]" />
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center relative z-10">
              ...
              >
                ...
                >
                  ...
                  {/* GLOW */}
                  <div className="absolute inset-0 rounded-2xl bg-blue-400/20 blur-2xl opacity-0 group-hover:opacity-100 transition duration-500" />
                ...
                <div className="flex gap-4 mt-10 flex-wrap">
                  ...
                  <div className="px-5 py-4 rounded-xl bg-white/10 border border-white/10 backdrop-blur-xl">
                    <p className="text-2xl font-black text-white">24/7</p>
                    <p className="text-xs text-[#B7C2D8] uppercase tracking-wider">
                      Support
                    </p>
                  </div>
